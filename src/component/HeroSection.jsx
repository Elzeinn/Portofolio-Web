        ...
        <>
            <section className="hero" id="home">
                ...
                <main className="content">
                    ...
                    <p ref={el}></p>
                    <a href="" className="cta">About Me</a>
                   
                    <div className="content-icon">
                         <a href="" dangerouslySetInnerHTML={{ __html: feather.icons.github.toSvg() }}></a>
                        <a href="" dangerouslySetInnerHTML={{ __html: feather.icons.instagram.toSvg() }}></a>
