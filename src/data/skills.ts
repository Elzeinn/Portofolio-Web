...
export const skills: Skill[] = [
  ...
  { name: "JavaScript/TypeScript", level: "Expert", icon: Code, color: "yellow" },
  ...
  { name: "Performance Optimization", level: "Expert", icon: Cpu, color: "red" },
  { name: "Server Security", level: "Expert", icon: Shield, color: "emerald" },
